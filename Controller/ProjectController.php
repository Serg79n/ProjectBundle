...
class ProjectController extends Controller {
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('"%alias%" is successfully updated!', array('%alias%' => $entity->getAlias()))
            );
    ...
    public function deleteAction(Request $request, $id) {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('"%alias%" is successfully deleted!', array('%alias%' => $entity->getAlias()))
            );
        } else {
            $this->get('session')->setFlash('error', $this->get('translator')->trans('Error deleting "%alias%".', array('%alias%' => $entity->getAlias()))
            );
        }
